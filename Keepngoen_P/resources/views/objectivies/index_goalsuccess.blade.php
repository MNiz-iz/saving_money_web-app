...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="container mt-2">
            ...
            <table class="table table-bordered">
                ...
                @foreach ($datas as $goals)
                    <tr>
                        ...
                        <td><a href="{{ route('upgoal.show', $goals->id) }}" class="btn btn-primary btn-lg disabled">KeepNgoen_NOW</a></td>
                        <td><form action="{{ route('objectivies.destroy', $goals->id) }}" method="POST">
                            <a href="{{ route('objectivies.edit', $goals->id) }}" method="POST" class="btn btn-warning disabled" style="width:150px">Edit This Goal  !!</a>
                            @csrf
                            @method('delete')
            ...
            <a href="{{ route('objectivies.index') }}" class="btn btn-primary btn-lg">BACK TO HOME</a>
        </div>
